...
<html lang="en">
  <head>
    <title>Nowara LLC | Home Page</title>
    ...
    <section class="slide slide-one">
      <div class="container">
        <div class="banner-text">
          ...
          <h3>Cosmatics Products<br>
            skin care Products</h3>
            ...
            <div class="grids">
                    <div class="grids-content row">
                        ...
                        <div class="column col-lg-4 col-md-6 color-2 ">
                            <div>
                            <h4 class=" ">Our Company is Most Popular</h4>
                            <p class="para ">Nowara's Offers - Beauty Services</p>
	...
	<div class="team-single-main ">
		<div class="container">
				...
				<div class="column2 image-text">
					<h3 class="team-head ">Come experience the secrets of our Products </h3>
					<p class="para  text ">
						Best Beauty expert at your home. a beauty professionals for beauty services at home through online training,Step by Step to build you own Salon at your home.</p>
        ...
        <div class="container">
            <div class=" row">
                ...
                <div class="col-lg-6 about-right-faq align-self">
                    <h3 class="title-big"><a href="about.html">Recommended makeup Producs you will find at Nowara</a></h3>
                    <p class="mt-3 para"> and more.</p>
                        <div class="hair-cut">
                            <div >
                    <ul class="w3l-right-book">
                        <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html">Eye Liner</a></li>
                        <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html">Eye Shadow</a></li>
                        <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html">Shampoo & Set</a></li>
                        <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html">Concealer</a></li>
                        <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html">Advance Hair Color</a></li>
                    </ul>
                </div>
                    <div  class="image-right">
                        <ul class="w3l-right-book">
                            <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html">Fundation</a></li>
                            <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html">Bronzer</a></li>
                            <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html">Face Powder</a></li>
                            <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html">Skin Care</a></li>
                            <li><span class="fa fa-check" aria-hidden="true"></span><a href="about.html">Body Care Producs</a></li>
                        </ul>
                </div>
            </div>
        </div>
